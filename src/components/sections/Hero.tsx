...
export function Hero() {
    return (
        <section id="hero" className="w-full py-16 md:py-20 bg-background dark:bg-onyx">
            <div className="max-w-6xl mx-auto px-4 md:px-6 grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-12 items-center">
                ...
                <div className="flex flex-col items-start space-y-6 md:space-y-8">
                    ...
                    <div className="space-y-4 md:space-y-6">
                        <h1 className="font-serif text-4xl md:text-5xl lg:text-6xl text-onyx dark:text-bone leading-tight font-medium">
                            Strategic Revenue Management for Short-Term Rentals
                        </h1>
                        <p className="font-sans text-lg md:text-xl text-onyx/75 dark:text-bone/75 leading-relaxed">
                    ...
                    <div className="space-y-4 mt-2">
                        <div className="flex items-start gap-3 text-onyx/90">
                            ...
                            <span className="text-sm md:text-base font-medium text-onyx dark:text-bone">Average 25%+ revenue increase per property</span>
                        </div>
                        <div className="flex items-start gap-3 text-onyx/90">
                            <BarChart3 className="w-5 h-5 text-moss shrink-0 mt-1" />
                            <span className="text-sm md:text-base font-medium text-onyx dark:text-bone">Data-driven pricing updated daily—no guesswork</span>
                        </div>
                        <div className="flex items-start gap-3 text-onyx/90">
                            <Handshake className="w-5 h-5 text-moss shrink-0 mt-1" />
                            <span className="text-sm md:text-base font-medium text-onyx dark:text-bone">Success-based fee: we win when you win</span>
                        </div>
                    </div>
                ...
                <div className="relative w-full h-full min-h-[400px] flex items-center justify-center">
                    <Card className="w-full aspect-[4/3] md:aspect-[16/10] rounded-2xl border border-onyx/10 dark:border-bone/10 overflow-hidden shadow-xl relative bg-gradient-to-br from-cedar/20 to-moss/20 dark:from-cedar/30 dark:to-moss/30">
                        ...
                        {/* Overlay Card */}
                        <div className="absolute bottom-6 left-6 right-6 bg-bone/90 dark:bg-onyx/90 backdrop-blur-sm border border-white/20 dark:border-bone/10 p-6 rounded-xl shadow-lg">
